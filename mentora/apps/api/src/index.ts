/**
 * Mentora API — Express application entry point.
 *
 * Bootstrap order:
 *  1. dotenv loads .env
 *  2. Helmet, CORS, Morgan, body parsers
 *  3. Static file serving for local storage adapter
 *  4. All API routers mounted under /api
 *  5. Health check + 404 handler + centralised error handler
 *  6. HTTP server starts on API_PORT
 */
